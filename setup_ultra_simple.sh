...
# 🔥 DC-Detector Ultra Simple Setup для Raspberry Pi
# Ультра-простая установка только самого необходимого
# Версия: 1.0
...
# Главная функция
main() {
    print_header "DC-Detector Ultra Simple Setup"
    print_info "Ультра-простая установка системы детекции огня для Raspberry Pi"
    echo ""
